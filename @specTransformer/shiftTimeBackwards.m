function newFormula = shiftTimeBackwards(formula, timeshift)
% SHIFTTIMEBACKWARDS   Shifts time backwards by timeshift in the given
% formula
%   formula is an STL formula (a string)
%   timeshift is a string (e.g. '1' or '25')
